...
exports.handler = async (event, context) => {
  ...
  let res;
  try {
    res = await client.get('/api/rest/v2/keyspaces/' + process.env.ASTRA_DB_KEYSPACE + '/locations?where=\{"location_type":\{"$eq":\"hotels"\}\}&fields=country,city,hotel_count,pitch')
